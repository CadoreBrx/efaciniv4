...
const MainListItems = (props) => {
  ...
  const handleEfaciniClick = () => {
    window.open("http://172.16.1.216/", "popup", "width=600,height=600");
  };

  const handleInternalChatClick = () => {
    window.open("https://cht.facilityai.com.br", "popup", "width=600,height=600");
  };
        ...
        color="inherit">
          ...
          <>
            ...
            <ListItemLink
              ...
              icon={<FlashOnIcon />}
              />
              <ListItem button dense onClick={handleEfaciniClick}>
                <ListItemIcon><FlashOnIcon /></ListItemIcon>
                <ListItemText primary="eFacini Cloud" />
              </ListItem>
              <ListItem button dense onClick={handleInternalChatClick}>
